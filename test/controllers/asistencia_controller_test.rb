...
class AsistenciaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create asistencium" do
    assert_difference('Asistencium.count') do
      post asistencia_url, params: { asistencium: { asistencia: @asistencium.asistencia, cedula: @asistencium.cedula, comentario: @asistencium.comentario, nombre: @asistencium.nombre } }
    end
  ...
  test "should update asistencium" do
    patch asistencium_url(@asistencium), params: { asistencium: { asistencia: @asistencium.asistencia, cedula: @asistencium.cedula, comentario: @asistencium.comentario, nombre: @asistencium.nombre } }
